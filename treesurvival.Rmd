...
There is a pretty strong negative relationship between elevation and survival for pin trees. It also appears that in more densely populated areas of pin trees, more trees die while in more sparsely populated regions more trees survive.  
...
There is also a negative relationship between elevation and survival for bur trees, though it is not quite as strong as that for pin trees. Additionally, we do not see as strong of a pattern related to tree density and survival for bur trees as we do for pin trees. 
